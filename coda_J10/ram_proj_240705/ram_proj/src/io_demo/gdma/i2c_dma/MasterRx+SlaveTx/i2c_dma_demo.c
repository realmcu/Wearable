...
void I2C0_Handler(void)
{
    if (I2C_GetINTStatus(I2C0, I2C_INT_RD_REQ) == SET)
    {
        ...
        //Add user code here
        APP_PRINT_INFO0("I2C_INT_RD_REQ");
        // clear interrupt
    ...
    {
        // add user code here
        APP_PRINT_INFO0("I2C_INT_RX_FULL");
...
void I2C1_Handler(void)
{
    ...
    {
        // add user code here
        APP_PRINT_ERROR0("I2C_INT_RX_UNDER");
        // clear interrupt
    ...
    {
        // add user code here
        APP_PRINT_INFO0("I2C1 stop detect");
        // clear interrupt
...
void i2c_tx_dma_handler(void)
{
    APP_PRINT_TRACE0("i2c_tx_dma_handler");
...
void i2c_rx_dma_handler(void)
{
    APP_PRINT_TRACE0("i2c_rx_dma_handler");
