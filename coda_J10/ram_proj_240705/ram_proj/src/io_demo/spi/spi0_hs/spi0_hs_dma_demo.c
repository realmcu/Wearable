...
uint8_t sendbuf[DMA_BUFFER_SIZE];
uint8_t readbuf[DMA_BUFFER_SIZE];
uint8_t spi_tx_dma_ch_num = 0;  /* SPI0_HS use dma channel 0 due to high performance */
uint8_t spi_rx_dma_ch_num = 1;  /* SPI0_HS use dma channel 1 due to high performance */
