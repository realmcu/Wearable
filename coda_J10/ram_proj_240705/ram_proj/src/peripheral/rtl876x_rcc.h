...
/* 0x234 */
#define APBPeriph_RTZIP_CLOCK               ((uint32_t)( 30 | (0x02UL << 29) | APBPeriph_SLEEP_CLOCK_EXIST))
...
#define APBPeriph_RTZIP                 ((uint32_t)( 26 | (0x00UL << 26)))
...
#define APBPeriph_TIMER1_PWM            ((uint32_t)( 21 | (0x00UL << 26)))
