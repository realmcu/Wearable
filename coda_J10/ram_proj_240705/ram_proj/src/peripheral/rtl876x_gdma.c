...
void GDMA_Init_rom(GDMA_ChannelTypeDef *GDMA_Channelx, GDMA_InitTypeDef *GDMA_InitStruct)
{
...
#if (GDMA_SUPPORT_TIMER_DMA_EN == 1)
    if (GDMA_InitStruct->GDMA_DestHandshake >= GDMA_Handshake_TIM1_CH4 &&
        GDMA_InitStruct->GDMA_DestHandshake <= GDMA_Handshake_TIM1_CH9)
    {
        SoC_VENDOR->u_024.BITS_024.reg_timer1_9_4_dma_en |= BIT(GDMA_InitStruct->GDMA_DestHandshake -
                                                                GDMA_Handshake_TIM1_CH4);
    }
#endif
    ...
    {
        gdma_0x18.b.SRC_GATHER_EN = GDMA_InitStruct->GDMA_Gather_En;
        GDMA_Channelx->GDMA_CTL_LOWx = gdma_0x18.d32;
    ...
    if (GDMA_IsGatherScatterChannel(GDMA_Channelx))
    {
        gdma_0x18.b.DST_SCATTER_EN = GDMA_InitStruct->GDMA_Scatter_En;
        GDMA_Channelx->GDMA_CTL_LOWx = gdma_0x18.d32;
