 ...
 */
#define CHIP_TIM_CHANNEL_NUM                        (12)
#define TIM_SUPPORT_LATCH_CNT_0                     (1)
#define TIM_SUPPORT_LATCH_CNT_1                     (1)
#define TIM_SUPPORT_LATCH_CNT_2                     (1)
#define TIM_SUPPORT_PWM_FUNCTION                    (1)
#define TIM_SUPPORT_PWM_PHASE_SHIFT                 (1)
#define TIM_SUPPORT_PWM_DEADZONE                    (1)
#define TIM_SUPPORT_CCR_FIFO4                       (0)
#define TIM_SUPPORT_CCR_FIFO8                       (1)
#define TIM_SUPPORT_DMA                             (1)

#define TIM_SUPPORT_ONESHOT_CMD                     (1)
#define TIM_SUPPORT_PWM_SRC_SELECT                  (1)
...
#define IS_TIM_ALL_PERIPH(PERIPH)    (((PERIPH) == TIM0_CH0) || \
                                      ((PERIPH) == TIM0_CH1) || \
                                      ((PERIPH) == TIM1_CH0) || \
                                      ((PERIPH) == TIM1_CH1) || \
                                      ((PERIPH) == TIM1_CH2) || \
