...
/**
  ...
  */
static __inline void RTC_ResetPrescalerCounter(void)
{
...
/**
  ...
  * @retval the counter value.
  */
static __inline uint32_t RTC_GetCounter(void)
{
    return RTC->CNT;
}
...
/**
  ...
  * @retval the counter value.
  */
static __inline void RTC_ResetCounter(void)
{
...
/**
  ...
  */
static __inline uint32_t RTC_GetComp(uint8_t index)
{
...
/**
  ...
  * @retval None
  */
static __inline void RTC_ClearCompINT(uint8_t index)
{
...
/**
  ...
  * @retval None
  */
static __inline void RTC_ClearCompWkINT(uint8_t index)
{
...
/**
  ...
  * @retval None.
  */
static __inline void RTC_ClearOverFlowINT(void)
{
...
/**
  ...
  * @retval None.
  */
static __inline void RTC_ClearTickINT(void)
{
...
/**
  ...
  * @retval None
  */
static __inline void RTC_SleepModeClkConfig(uint32_t clock)
{
