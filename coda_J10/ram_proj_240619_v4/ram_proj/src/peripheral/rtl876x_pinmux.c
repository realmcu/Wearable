...
const T_PINMUX_INDEX_TABLE pinmux_index_table =
{
    ...
    .index[DP] =     96,
    .index[DM] =     97,
    .index[SPIC1_SIO2] = 100,
    .index[SPIC1_SO] = 101,
    .index[SPIC1_CSN] = 102,
    .index[SPIC1_SI] = 103,
    .index[SPIC1_SCK] = 104,
    .index[SPIC1_SIO3] = 105,
};

/******************* Reference: BB2Ultra_IO_module_20240607_v0.xlsx *******************/
...
const T_PIN_ADDR_TABLE pad_wake_sts_table =
{
    ...
    .reg[DAOUT_P] =    PAD_ITEM(0x7F6, 6),
    .reg[DAOUT_N] =    PAD_ITEM(0x7F6, 7),
    .reg[MICBIAS] =    PAD_ITEM(0x7F6, 12),
    .reg[P10_0] =      PAD_ITEM(0x7F8, 0),
};

/******************* Reference: BB2Ultra_REG_20240606_V2.xlsx *******************/
