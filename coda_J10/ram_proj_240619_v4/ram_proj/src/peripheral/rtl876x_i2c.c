...
void I2C_SetClockSpeed(I2C_TypeDef *I2Cx, uint32_t I2C_ClockSpeed)
{
    ...
    if (I2C_ClockSpeed <= 100000)
    {
        scl_low_period_min_ns = I2C_STANDARD_MODE_SCL_LOW_PERIOD_MIN_NS;
        scl_high_period_min_ns = I2C_STANDARD_MODE_SCL_HIGH_PERIOD_MIN_NS;
    }
    else if (I2C_ClockSpeed <= 400000)
    {
        scl_low_period_min_ns = I2C_FAST_MODE_SCL_LOW_PERIOD_MIN_NS;
        scl_high_period_min_ns = I2C_FAST_MODE_SCL_HIGH_PERIOD_MIN_NS;
    }
    else
    {
        ...
        i2c_0xa0.b.ic_fs_spklen = 0x02;
        I2Cx->IC_FS_SPKLEN = i2c_0xa0.d32;
        scl_low_period_min_ns = I2C_FAST_MODE_PLUS_SCL_LOW_PERIOD_MIN_NS;
        scl_high_period_min_ns = I2C_FAST_MODE_PLUS_SCL_HIGH_PERIOD_MIN_NS;
    }
...
void I2C_RxFIFOFullHoldCtrl(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    ...
    IC_CON_TypeDef i2c_0x00 = {.d32 = I2Cx->IC_CON};
    i2c_0x00.b.rx_fifo_full_hld_ctrl = NewState;
    I2Cx->IC_CON = i2c_0x00.d32;
}
