...
uint8_t pin_0_state = 0;
uint8_t pin_1_state = 0;
uint8_t pin_2_state = 0;
uint8_t pin_3_state = 0;
...
void System_Handler(void)
{
    if (System_WakeUpInterruptValue(GPIO_DEMO_INPUT_PIN0))
    {
        ...
        IO_PRINT_INFO1("pin0 interrupt triggered %d", pin_0_state);
    }
    ...
    if (System_WakeUpInterruptValue(GPIO_DEMO_INPUT_PIN1))
    {
        ...
        IO_PRINT_INFO1("pin1 interrupt triggered %d", pin_1_state);
    }
    ...
    if (System_WakeUpInterruptValue(GPIO_DEMO_INPUT_PIN2))
    {
        ...
        IO_PRINT_INFO1("pin2 interrupt triggered %d", pin_2_state);
    }
    ...
    if (System_WakeUpInterruptValue(GPIO_DEMO_INPUT_PIN3))
    {
        ...
        IO_PRINT_INFO1("pin2 interrupt triggered %d", pin_3_state);
    }
...
{
    IO_PRINT_INFO0("pad interrupt demo start");
