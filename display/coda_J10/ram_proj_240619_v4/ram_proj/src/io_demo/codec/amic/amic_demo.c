...
**********************************************************************************************************
* @file     main.c
* @brief    This file provides demo code of amic comunication.
* @details
* @author   renee
* @date     2017-04-19
* @version  v1.0
...
{
    Pad_Config(MIC1_P, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_DISABLE, PAD_OUT_LOW);
    Pad_Config(MIC1_N, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_DISABLE, PAD_OUT_LOW);
    Pad_Config(MIC2_P, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_DISABLE, PAD_OUT_LOW);
    Pad_Config(MIC2_N, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_DISABLE, PAD_OUT_LOW);
    Pad_Config(MICBIAS, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_ENABLE, PAD_OUT_LOW);

    PAD_AnalogConfig(MIC1_P, 1);
    PAD_AnalogConfig(MIC1_N, 1);
    PAD_AnalogConfig(MIC2_P, 1);
    PAD_AnalogConfig(MIC2_N, 1);
    PAD_AnalogConfig(MICBIAS, 1);
}
...
void driver_codecinif_init(void)
{
    ...
    CodecInIf_InitStruct.InputMode = AMicIn_Mode;
