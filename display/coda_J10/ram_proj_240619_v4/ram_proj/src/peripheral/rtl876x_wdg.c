...
{
    HAL_WRITE32(SYSON_BASE, 0x230, HAL_READ32(SYSON_BASE, 0x230) | BIT6);
    HAL_WRITE32(SYSON_BASE, 0x360, HAL_READ32(SYSON_BASE, 0x360) | BIT8);
    HAL_WRITE32(SYSON_BASE, 0x210, HAL_READ32(SYSON_BASE, 0x210) | BIT16);
}
