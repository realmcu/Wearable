...
#define DATA_SRAM1_ADDR  DATA_SRAM1_BASE
#define DATA_SRAM1_SIZE  (96*1024)
#define DATA_RAM_SIZE    (DATA_SRAM0_SIZE + DATA_SRAM1_SIZE)
#define DSP_SHM_ADDR     (DATA_SRAM1_BASE + DATA_SRAM1_SIZE)
...
#define HEAP_DATA_OFF_SIZE          (160 * 1024)
