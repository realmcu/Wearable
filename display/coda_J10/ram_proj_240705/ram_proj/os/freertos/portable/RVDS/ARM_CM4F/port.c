...
#error This port can only be used when the project options are configured to disable hardware floating point support.
#endif
...
static const volatile uint8_t *const pcInterruptPriorityRegisters = (uint8_t *)
...
BaseType_t xPortStartScheduler(void)
{
...
#if( configASSERT_DEFINED == 1 )
    {
        ...
        volatile uint8_t *const pucFirstUserPriorityRegister = (uint8_t *)(portNVIC_IP_REGISTERS_OFFSET_16 +
