...
#define RTC_SUPPORT_COMP_GT                            (0)
#define RTC_SUPPORT_INDIRECT_ACCESS                    (1)
...
typedef struct
{
    ...
    __IO uint32_t RSVD_20[4];               /*!< 0x20 - 0x2C */
...
/* 0x00
   ...
   28:24   R      reserver000_28_24   5'h0
...
typedef union
{
    ...
    struct
    {
        ...
        const uint32_t reserver000_7_3: 5;
            ...
            const uint32_t reserver000_28_24: 5;
    ...
    */
    ...
    /* 0x10
       23:0    R/W    rtc_cmp0            24'h0
       31:24   R      reserver010_31_24   8'h0
    */
    typedef union
        {
            uint32_t d32;
            struct
            {
                uint32_t rtc_cmp0: 24;
                const uint32_t reserver010_31_24: 8;
            } b;
        } RTC_COMP_0_TypeDef;


    /* 0x14
       23:0    R/W    rtc_cmp1            24'h0
       31:24   R      reserver014_31_24   8'h0
    */
    typedef union
        {
            uint32_t d32;
            struct
            {
                uint32_t rtc_cmp1: 24;
                const uint32_t reserver014_31_24: 8;
            } b;
        } RTC_COMP_1_TypeDef;


    /* 0x18
       23:0    R/W    rtc_cmp2            24'h0
       31:24   R      reserver018_31_24   8'h0
    */
    typedef union
        {
            uint32_t d32;
            struct
            {
                uint32_t rtc_cmp2: 24;
                const uint32_t reserver018_31_24: 8;
            } b;
        } RTC_COMP_2_TypeDef;


    /* 0x1C
       23:0    R/W    rtc_cmp3            24'h0
       31:24   R      reserver01c_31_24   8'h0
    */
    typedef union
        {
            uint32_t d32;
            struct
            {
                uint32_t rtc_cmp3: 24;
                const uint32_t reserver01c_31_24: 8;
            } b;
        } RTC_COMP_3_TypeDef;

    /* 0x30
       23:0    R      rtc_cnt             24'h0
       31:24   R      reserver030_31_24   8'h0
    */
    typedef union
        {
            uint32_t d32;
            struct
            {
                const uint32_t rtc_cnt: 24;
                const uint32_t reserver030_31_24: 8;
            } b;
        } RTC_CNT0_TypeDef;
