...
#define SDIO                        ((SDIO_TypeDef *) SDIO_HOST0_CFG_BASE)
 ...
 */
__STATIC_ALWAYS_INLINE uint16_t SDIO_GetAllErrINTStatus(void)
{
    return SDIO->ERR_INTR_SR;
}
/**
 ...
 */
__STATIC_ALWAYS_INLINE uint16_t SDIO_GetAllNorINTStatus(void)
{
    return SDIO->NORMAL_INTR_SR;
}
