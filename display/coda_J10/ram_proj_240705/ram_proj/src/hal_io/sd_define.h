...
#define sd_print_error(fmt, ...) DBG_BUFFER(TYPE_BB2, SUBTYPE_FORMAT, MODULE_SDIO, LEVEL_ERROR, "!!!"fmt, COUNT_ARGS(__VA_ARGS__), ##__VA_ARGS__)
#define sd_print_info(fmt, ...)  DBG_BUFFER(TYPE_BB2, SUBTYPE_FORMAT, MODULE_SDIO, LEVEL_INFO, "!**"fmt, COUNT_ARGS(__VA_ARGS__), ##__VA_ARGS__)
#define sd_print_trace(fmt, ...) DBG_BUFFER(TYPE_BB2, SUBTYPE_FORMAT, MODULE_SDIO, LEVEL_TRACE, fmt, COUNT_ARGS(__VA_ARGS__), ##__VA_ARGS__)
#define sd_print_bin(fmt, ...)   DBG_BUFFER(TYPE_BB2, SUBTYPE_FORMAT, MODULE_SDIO, LEVEL_INFO, "!**"fmt, COUNT_ARGS(__VA_ARGS__), ##__VA_ARGS__)
