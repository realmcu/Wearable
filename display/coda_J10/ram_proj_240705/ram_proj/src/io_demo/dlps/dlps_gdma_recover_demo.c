...
/* uart received data */
uint8_t uart_receive_buf[UART_BUFFER_SIZE];

/* uart dma channel */
uint8_t uart_rx_dma_ch_num = 0xa5;

/* uart allow enter dlps */
bool uart_allow_enter_dlps = true;
    ...
    case UART_INT_ID_LINE_STATUS:
        {
            ...
            APP_PRINT_ERROR1("Line status error!!!!0x%x\n", UART_GetLineStatus(UART));
...
{
    APP_PRINT_TRACE0("uart_rx_dma_handler");
...
RAM_TEXT_SECTION bool uart_dlps_check_callback(void)
{
...
void dlps_gdma_recover_init(void)
{
