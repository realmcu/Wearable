...
/**
  ...
  * @return  void
  */
void driver_rtc_nvic_init(void)
{
...
/**
  ...
  * @return  void
  */
void app_dlps_system_wakeup_by_rtc(uint32_t wakeup_time_s)
{
...
void app_dlps_enter_callback(void)
{
    ...
    if (lps_mode == POWER_POWERDOWN_MODE)
    {
        ...
        DBG_DIRECT("dlps_system_wakeup_by_rtc: 10 sec");
    }
}
