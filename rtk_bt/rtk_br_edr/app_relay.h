...
typedef enum
{
    ...
    APP_MODULE_TYPE_ISOAUDIO          = 0x1B,
    APP_MODULE_TYPE_BLE_RAND_ADDR     = 0x1D,
    APP_MODULE_TYPE_ROLESWAP_CTRL     = 0x1E,
    APP_MODULE_TYPE_LOC               = 0x1F,
    ...
    APP_MODULE_TYPE_TEAMS_CFU         = 0x91,
