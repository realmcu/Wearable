...
//************* Start Initial Sequence **********//
    platform_delay_ms(120); // Delay 120ms
    ...
    st7796_write_data(0xa7);
    st7796_write_cmd(0xc5);
    st7796_write_data(0x18);
    st7796_write_cmd(0xe0); //Positive Voltage Gamma Control
    st7796_write_data(0xf0);
    st7796_write_data(0x09);
    st7796_write_data(0x0b);
    st7796_write_data(0x06);
    st7796_write_data(0x04);
    st7796_write_data(0x15);
    st7796_write_data(0x2f);
    ...
    st7796_write_cmd(0xe1); //Negative Voltage Gamma Control
    st7796_write_data(0xf0);
    st7796_write_data(0x09);
    st7796_write_data(0x0b);
    st7796_write_data(0x06);
